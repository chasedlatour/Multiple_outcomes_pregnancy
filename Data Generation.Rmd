...
each_sim <- function(n_sim, n){
  ...
  data <- dplyr::tibble(
    ...
    rowwise %>% 
    mutate(
      # Create the pregnancy outcomees for Phase 1 of the data generation
      phase1_outcomes = list(sample_outcomes_for_id(phase1)), 
      
      # Identify the last gestational week that a person experiences up to 20 weeks of gestation
