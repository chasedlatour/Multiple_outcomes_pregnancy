...
We will calculate this for all three ways of analyzing the data. Further, we will eventually quantify how much, on average, the KM estimator over-estimated the risk compared to a situation in which there was no censoring and a situation in which an AJ estimator was used to account for censoring.
