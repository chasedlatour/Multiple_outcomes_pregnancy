...
library(kableExtra)
library(showtext)
font_add("Calibri", "/Library/Fonts/calibri.ttf") 

# Enable showtext for rendering
showtext_auto()

# library(extrafont)
# font_import(paths = "/Library/Fonts", pattern = "calibri.ttf", prompt=FALSE)
...
pdf("Primary efficacy outcome - risks.pdf", height = 6, width = 4.4)
...
ggplot(figure_efficacy2) +
  ...
  theme(legend.position = "bottom",
        axis.text.y = element_text(size = 14, family = "Calibri", color="black"),
        axis.text.x = element_text(size=14, family = "Calibri", color="black"),
        strip.text = element_text(size = 14, family = "Calibri", color="black"),
        legend.text = element_text(size = 12, family = "Calibri", color="black"),
        axis.title.x = element_text(family = "Calibri", size=14, color="black"),
        axis.title.y = element_text(family = "Calibri", size=14, color="black"),
        plot.title = element_text(family = "Calibri", size=14, color="black"),
        legend.title = element_text(family = "Calibri", size=12, color="black"),
...
pdf("Primary efficacy outcome - RDs.pdf", height = 6, width = 3.1)
...
ggplot(figure_efficacy2) +
  ...
  geom_vline(data = unique_rd_values, aes(xintercept = composite_truth_rd), linetype = "dashed", color = "red") +
   geom_label(aes(y = Estimator, x = 1.2, label = scales::number(rd_absolute_bias, accuracy = 0.1)), fill = "white", label.size = NA, family = "Calibri", size=3.7, color="black") +
  facet_wrap(scenario ~ ., ncol = 1, strip.position = "left") +
  labs(y = "Scenario", 
  ...
  theme(legend.position = "bottom",
        ...
        axis.title.y = element_text(family = "Calibri", size=14, color="black"),
        plot.title = element_text(family = "Calibri", size=14, color="black"),
        axis.title.x.bottom = element_text(hjust = 0.4, color="black"),
        panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        panel.grid.major.x = element_line(color = "grey70", linewidth = 0.3),
        panel.grid.minor.x = element_line(color = "grey70", linewidth = 0.3),
...
pdf("Primary efficacy outcome - RRs.pdf", height = 6, width = 3.1)

ggplot(figure_efficacy2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.06, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri", size=3.7, color="black") +
  ...
  theme(legend.position = "bottom",
        ...
        axis.text.x = element_text(size = 14, family = "Calibri", color="black"),
        strip.text = element_text(size = 14, family = "Calibri", color="black"),
        legend.text = element_text(size = 14, family = "Calibri", color="black"),
        axis.title.x = element_text(size=14, family = "Calibri", color="black"),
        axis.title.y = element_text(size=14, family = "Calibri", color="black"),
        plot.title = element_text(size=14, family = "Calibri", color="black"),
        panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        panel.grid.major.x = element_line(color = "grey70", linewidth = 0.3),
        panel.grid.minor.x = element_line(color = "grey70", linewidth = 0.3),
...
pdf("Primary safety outcome - RDs - 1-6.pdf", height = 6, width = 3.1)

ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RD)) +
   geom_errorbarh(aes(y = Estimator, xmin = RD_LCL, xmax = RD_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1, 
                 label = scales::number(rd_absolute_bias, accuracy = 0.1)), 
             fill = "white", label.size = NA, family="Calibri", size=3.7, color="black") +
...
pdf("Primary safety outcome - RRs - 1-6.pdf", height = 6, width = 3.1)

ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.03, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri", size=3.7, color="black") +
...
pdf("Primary safety outcome - RDs - 7-12.pdf", height = 6, width = 3.1)

ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RD)) +
   geom_errorbarh(aes(y = Estimator, xmin = RD_LCL, xmax = RD_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 4.5, 
                 label = scales::number(rd_absolute_bias, accuracy = 0.1)), 
             fill = "white", label.size = NA, family="Calibri", size=3.7, color="black") +
  geom_vline(data = unique_rd_values, aes(xintercept = sga_truth_rd), 
             linetype = "dashed", 
...
pdf("Primary safety outcome - RRs - 7-12.pdf", height = 6, width = 3.1)

ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.08, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri", size=3.7, color="black") +
  geom_vline(data = unique_rd_values, aes(xintercept = sga_truth_rr), linetype = "dashed", color = "red") +
  facet_wrap(scenario ~ ., ncol = 1, strip.position = "left") +
  labs(y = "Scenario", 
       x = "Risk Ratio (log-scale)",
