...
ggplot(figure_efficacy2) +
  ...
  theme(legend.position = "bottom",
        axis.text.y = element_text(size = 14, family = "Calibri"),
        axis.text.x = element_text(size=14, family = "Calibri"),
        strip.text = element_text(size = 14, family = "Calibri"),
        legend.text = element_text(size = 12, family = "Calibri"),
        axis.title.x = element_text(family = "Calibri", size=14),
        axis.title.y = element_text(family = "Calibri", size=14),
        plot.title = element_text(family = "Calibri", size=14),
        legend.title = element_text(family = "Calibri", size=12),
        # panel.grid.major = element_line(color = "grey70"),  # Darker major gridlines
...
ggplot(figure_efficacy2) +
  ...
  # geom_text(aes(y = Estimator, x = 1.2, 
  #             label = scales::number(rd_absolute_bias, accuracy = 0.1)), 
  #         family = "Calibri", size = 8) +
  # geom_label(aes(y = Estimator, x = 1.2, label = scales::number(rd_absolute_bias, accuracy = 0.1)), fill = "white", label.size = NA, family="Calibri") +
  geom_vline(data = unique_rd_values, aes(xintercept = composite_truth_rd), linetype = "dashed", color = "red") +
   geom_label(aes(y = Estimator, x = 1.2, label = scales::number(rd_absolute_bias, accuracy = 0.1)), fill = "white", label.size = NA, family = "Calibri", size=4.5) +
  facet_wrap(scenario ~ ., ncol = 1, strip.position = "left") +
  labs(y = "Scenario", 
...
ggplot(figure_efficacy2) +
  ...
  geom_label(aes(y = Estimator, x = 1.06, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri", size=4.5) +
...
ggplot(figure_safety2) +
  ...
  geom_label(aes(y = Estimator, x = 1, 
                 label = scales::number(rd_absolute_bias, accuracy = 0.1)), 
             fill = "white", label.size = NA, family="Calibri", size=4.5) +
...
ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.03, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri", size=4.5) +
...
ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.08, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri", size=4.5) +
  geom_vline(data = unique_rd_values, aes(xintercept = sga_truth_rr), linetype = "dashed", color = "red") +
  facet_wrap(scenario ~ ., ncol = 1, strip.position = "left") +
  labs(y = "Scenario", 
       x = "Log-Scaled Risk Ratio",
