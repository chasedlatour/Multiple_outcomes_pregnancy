...
ggplot(figure_efficacy2) +
  ...
  geom_label(aes(y = Estimator, x = 1.06, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri") +
...
ggplot(figure_safety2) +
  ...
  geom_label(aes(y = Estimator, x = 1, 
             ...
             fill = "white", label.size = NA, family="Calibri") +
...
ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.03, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri") +
...
ggplot(figure_safety2) +
  geom_point(aes(y = Estimator, x = RR)) +
  geom_errorbarh(aes(y = Estimator, xmin = RR_LCL, xmax = RR_UCL), height = 0.1, color = "black") +
  geom_label(aes(y = Estimator, x = 1.08, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri") +
  geom_vline(data = unique_rd_values, aes(xintercept = sga_truth_rr), linetype = "dashed", color = "red") +
   geom_label(aes(y = Estimator, x = 1.08, label = scales::number(rr_absolute_bias, accuracy = 0.01)), fill = "white", label.size = NA, family="Calibri") +
  facet_wrap(scenario ~ ., ncol = 1, strip.position = "left") +
  labs(y = "Scenario", 
